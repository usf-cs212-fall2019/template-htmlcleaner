...
/**
 * Tests the {@link HtmlCleaner} class, specifically the individual methods
 * that strip different HTML components.
 */
@TestMethodOrder(OrderAnnotation.class)
public class HtmlCleanerRemoteTest {

	/**
	 * Fetches the HTML from a URL and cleans the text, making sure the end
